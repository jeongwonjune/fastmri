...
def parse():
    ...
    parser.add_argument('-n', '--net-name', type=Path, default='Varnet', help='Name of network')
    parser.add_argument('-t', '--data-path', type=Path, default='../recon_data/recon_varnet/', help='Directory of data')
    parser.add_argument('-o', '--out-path', type=Path, default='../recon_data/recon_narnet/')
...
if __name__ == '__main__':
    ...
    args.data_path_leaderboard_acc4 = args.data_path / 'acc5'
    args.data_path_leaderboard_acc8 = args.data_path / 'acc9'
    
    args.out_path_train = args.out_path / 'train'
    args.out_path_val = args.out_path / 'val'
    args.out_path_leaderboard_acc4 = args.out_path / 'acc5'
    args.out_path_leaderboard_acc8 = args.out_path / 'acc9'
