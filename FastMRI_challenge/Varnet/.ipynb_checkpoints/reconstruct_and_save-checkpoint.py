...
def parse():
    ...
    parser.add_argument('-t', '--data-path', type=Path, default='/home/Data/', help='Directory of data')
...
if __name__ == '__main__':
    ...
    args.data_path_leaderboard_acc4 = args.data_path / 'leaderboard' / 'acc5'
    args.data_path_leaderboard_acc8 = args.data_path / 'leaderboard' / 'acc9'
